...
- 플레이: 소방학교 훈련 → 일상 위험 대처(퀴즈) → 지진 1차: 밸브 차단·잔불 진압 → 지진 2차: 가스 누출·환기 → 랭크 결산(S/A/B)
- 재미 요소: 밸브 잠금 미니게임(연타→타이밍), 소화기 조준·쓸기 분사, 창문 열기·비눗물 점검, 배지 수집(6종), 타격감 연출
- 씬 3종: 기본 주방 / 넓은 주방(1인칭 지원) / 모듈 주방(Tripo 생성 킷) — 타이틀에서 1·2·3

## 스크린샷

| | |
|---|---|
| ![타이틀](Docs/shots/title.jpg) | ![기본 주방](Docs/shots/scene1_basic.jpg) |
| 타이틀 — 배지 도감·씬 선택 | 기본 주방 (원근 쿼터뷰) |
| ![밸브 미니게임](Docs/shots/minigame_valve.jpg) | ![랭크](Docs/shots/rank.jpg) |
| 밸브 잠금 미니게임 (연타→타이밍) | 훈련 결과 랭크 (칠판 UI) |
| ![모듈 주방](Docs/shots/scene3_mod.jpg) | ![1인칭](Docs/shots/scene2_fp_view.jpg) |
| 모듈 주방 — Tripo 생성 킷 조립 | 1인칭 시점 (V키 전환) |
